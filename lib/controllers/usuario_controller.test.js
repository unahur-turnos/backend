...
describe('Usuario controller', () => {
  ...
  //   t('Actualizar contraseña', async () => {
  //     iconst req = (await getAuthorizedRequest(informatico)).request;
  //     const response = await req.put('/api/usuarios/credenciales').send({ contrasenia: "NuevaPass1234" });
  //   expect(response.statusCode).toBe(200);
  // });
