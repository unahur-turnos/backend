...
import { asuntoRegistro, turnosUnahurUrl } from '../config/mail_sender';
  ...
  new LocalStrategy(
    ...
    async (req, dni, contrasenia, done) => {
      try {
        ...
        const templateRegistro = await HTMLUtils.getHTMLFile(
          'lib/html/templateRegistro.html',
          { nombreUsuario: usuario.nombre, turnosUnahurUrl }
        );
