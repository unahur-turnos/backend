...
import Actividad, { ActividadSinCuposError, TieneMasDeDosTurnosError } from './actividad';
...
describe('Actividad', () => {
  let informatico, espacio, espacioDosLugares, actividad, actividad1, actividad2, otraPersona;
  ...
  beforeEach(async () => {
    ...
    actividad = await Actividad.create({
      ...
      fechaHoraInicio: DateTime.fromISO('2021-11-10T09:00:00').toISO(),
      fechaHoraFin: DateTime.fromISO('2021-11-10T11:00:00').toISO(),
    ...
    actividad1 = await Actividad.create({
      espacioId: espacio.id,
      nombre: 'Clase de laboratorio',
      fechaHoraInicio: DateTime.fromISO('2021-11-10T12:00:00').toISO(),
      fechaHoraFin: DateTime.fromISO('2021-11-10T15:00:00').toISO(),
      responsable: 'Mariela Tocino',
      telefonoDeContactoResponsable: '11458679',
      activa: true,
      requiereControl: false,
    ...
    actividad2 = await Actividad.create({
      espacioId: espacio.id,
      nombre: 'Clase de laboratorio',
      fechaHoraInicio: DateTime.fromISO('2021-11-10T17:00:00').toISO(),
      fechaHoraFin: DateTime.fromISO('2021-11-10T20:00:00').toISO(),
      responsable: 'Mariela Tocino',
      telefonoDeContactoResponsable: '11458679',
      activa: true,
      requiereControl: false,
  ...
  describe('sacarTurnoPara', () => {
    let turnoInformatico, turnoInformatico1;
    ...
    beforeEach(async () => {
      ...
      turnoInformatico1 = await actividad1.sacarTurnoPara({
        usuario: informatico,
        medioDeTransporte: 'Movilidad propia',
      });
    ...
    it('cuando saca 2 turnos en un dia', async () => {
      expect(turnoInformatico).toMatchObject({
        actividadId: actividad.id,
        usuarioId: informatico.id,
        medioDeTransporte: 'Movilidad propia',
      });
      expect(turnoInformatico1).toMatchObject({
      ...
      it('cuando quiere sacar el tercero', async () => {
        await expect(
          actividad2.sacarTurnoPara({
            usuario: informatico,
            medioDeTransporte: 'Movilidad propia',
          })
        ).rejects.toThrowError(TieneMasDeDosTurnosError);
      });
