...
export default class Usuario extends Model {
  ...
  async tieneMasDeDosTurnos(actividad) {
    //console.log(actividad.fechaHoraInicio)
      ...
      include: [
        {
          ...
          where: {
            fechaHoraInicio: {
              [Op.eq]: [
                getInicioDelDia(
                  DateTime.fromISO(actividad.fechaHoraInicio).toISODate()
                ),
                //getFecha(actividad.fechaHoraInicio)
              ],
            },
          },
        },
